...
/** @type {string} */
const CACHE_VERSION = '1733502036|3239400863';
/** @type {string} */
const CACHE_PREFIX = 'Dream Plaza-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Dream Plaza.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Dream Plaza.html","Dream Plaza.js","Dream Plaza.offline.html","Dream Plaza.icon.png","Dream Plaza.apple-touch-icon.png","Dream Plaza.worker.js","Dream Plaza.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Dream Plaza.wasm","Dream Plaza.pck"];
